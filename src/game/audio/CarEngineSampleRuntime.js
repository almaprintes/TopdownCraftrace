...
export class CarEngineSampleRuntime{
 ...
 update(force=false){
  ...
  n.cabin.frequency.setTargetAtTime(300+rpm01*360,now,.12);n.cabin.gain.setTargetAtTime(4.2-rpm01*1.4+load*.55,now,.12);n.lowBody.gain.setTargetAtTime(5.5-rpm01*1.8,now,.12);n.roof.frequency.setTargetAtTime(1450+rpm01*3600+load*500,now,.10);n.windFilter.frequency.setTargetAtTime(1120+speed01*2450,now,.14);n.windGain.gain.setTargetAtTime(Math.pow(speed01,1.8)*.010*p.effects,now,.12);
