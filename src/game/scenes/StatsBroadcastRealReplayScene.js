...
export class StatsScene extends ReplayStatsScene{
  ...
  _installBroadcastStyles(){
    ...
    s.textContent=`
      ...
      @media(max-height:430px){.br-native-monitor{min-height:0!important;height:auto!important}.br-native-screen{height:252px}.br-native-monitor .br-monitor-head{height:44px}.br-replay-modal{padding:5px}.br-replay-modal__screen{height:300px;min-height:0;padding-bottom:0}.br-replay-modal__head{height:40px}.br-tel-bottom{bottom:0;height:50px}.br-replay-controls{height:52px;flex:0 0 52px}.br-replay-controls button{height:32px}.br-replay-controls button[data-br-play]{flex-basis:132px!important;width:132px!important;min-width:132px!important;max-width:132px!important;font-size:10px!important}.br-tel-card{padding:6px 8px}.br-tel-row{padding-top:2px;margin-top:2px}}
    `;
