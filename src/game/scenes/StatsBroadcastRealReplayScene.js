...
export class StatsScene extends ReplayStatsScene{
  ...
  _installBroadcastStyles(){
    ...
    s.textContent=`
      ...
      .br-replay-modal__head strong{display:block;font-size:13px}.br-replay-modal__head small{display:block;color:#76909f;font-size:7px;font-weight:900}.br-replay-modal__screen{position:relative;height:min(62vw,560px);min-height:300px;background:#020a11;overflow:hidden;padding:0 190px 118px;box-sizing:border-box}
      ...
      @media(max-height:430px){.br-native-monitor{min-height:0!important;height:auto!important}.br-native-screen{height:252px}.br-native-monitor .br-monitor-head{height:44px}.br-replay-modal{padding:5px}.br-replay-modal__screen{height:248px;min-height:0;padding-bottom:50px}.br-replay-modal__head{height:40px}.br-tel-bottom{bottom:0;height:50px}.br-replay-controls{height:52px;flex:0 0 52px}.br-replay-controls button{height:32px}.br-tel-card{padding:6px 8px}.br-tel-row{padding-top:2px;margin-top:2px}}
    `;
  ...
  _showRaceControlReplayModal(record,ghost,label='REPLAY'){
    ...
    modal.innerHTML=`<section class="br-replay-modal__panel" role="dialog" aria-modal="true" aria-label="Race Control replay"><div class="br-replay-modal__head"><div><div class="br-label">RACE CONTROL // ${esc(label)}</div><strong>${esc(trackId).toUpperCase()}</strong><small>${esc(carId).toUpperCase()} · ${fmt(ghost.lapMs)}</small></div><button type="button" class="br-replay-modal__close" data-br-modal-close>CERRAR ✕</button></div><div class="br-replay-modal__screen" data-br-native-replay-screen="1"><div class="br-native-loading" data-br-native-loading>CARGANDO REPLAY REAL…</div><div class="br-replay-telemetry" data-br-telemetry><aside class="br-tel-left"><div class="br-tel-card"><div class="br-tel-label">VUELTA EN REPRODUCCIÓN</div><div class="br-tel-big" data-tel-time>0:00.000</div><div class="br-tel-row"><span>MEJOR VUELTA</span><b>${fmt(ghost.lapMs)}</b></div><div class="br-tel-row"><span>PROGRESO</span><b data-tel-progress>0%</b></div></div><div class="br-tel-card"><div class="br-tel-label">PILOTO / MÁQUINA</div><div class="br-tel-car">${esc(carId).toUpperCase()}</div><div class="br-tel-row"><span>CIRCUITO</span><b>${esc(trackId).toUpperCase()}</b></div><div class="br-tel-row"><span>MUESTRAS</span><b>${ghost.samples.length}</b></div><div class="br-tel-row"><span>FRECUENCIA</span><b data-tel-hz>—</b></div><div class="br-tel-row"><span>SECTOR</span><b data-tel-sector>S1</b></div></div></aside><aside class="br-tel-right"><div class="br-tel-card"><div class="br-tel-label">VELOCIDAD ESTIMADA</div><div class="br-tel-speed"><span data-tel-speed>0</span> <small>km/h</small></div><div class="br-tel-bar"><i data-tel-speedbar></i></div><div class="br-tel-row"><span>RITMO</span><b data-tel-pace>0%</b></div><div class="br-tel-row"><span>V. MÁX</span><b data-tel-vmax>0 km/h</b></div><div class="br-tel-row"><span>DISTANCIA</span><b data-tel-distance>0 m</b></div></div><div class="br-tel-card"><div class="br-tel-label">TRAZADA / DATOS</div><div class="br-tel-row"><span>RUMBO</span><b data-tel-heading>0°</b></div><div class="br-tel-row"><span>SECTOR</span><b data-tel-sector-right>S1</b></div><div class="br-tel-row"><span>POSICIÓN</span><b data-tel-pos>0 / 0</b></div></div></aside><div class="br-tel-bottom"><div>ESTADO<strong data-tel-state>REPLAY</strong></div><div>TRAZADA<strong data-tel-analysis>ANÁLISIS ON</strong></div><div>FORMATO<strong>RACE DATA</strong></div><div>FUENTE<strong>${esc(label)}</strong></div><div>CONTROL<strong>REPLAY</strong></div></div></div><div class="br-replay-controls" data-br-controls><button type="button" data-br-start>↶ 0</button><button type="button" data-br-prev>◀│</button><button type="button" data-br-play>Ⅱ</button><button type="button" data-br-next>│▶</button><input data-br-seek type="range" min="0" max="${Math.max(1,Math.round(Number(ghost.lapMs)||1))}" step="1" value="0" aria-label="Posición del replay"><span class="br-ctl-time" data-br-ctl-time>0:00.000</span><button type="button" data-br-speed>1×</button><button type="button" data-br-analysis>TRAZADA ✓</button></div></section>`;
