...
export class StatsScene extends ReplayStatsScene{
  ...
  _bindPlayerBar(ghost){
    ...
    bar.querySelector('[data-player-analysis]')?.addEventListener('click',e=>{this._tdrReplayAnalysisEnabled=this._tdrReplayAnalysisEnabled===false;e.currentTarget.textContent=this._tdrReplayAnalysisEnabled?'⌁':'○';e.currentTarget.title=this._tdrReplayAnalysisEnabled?'Ocultar trazada':'Mostrar trazada';});
  }
