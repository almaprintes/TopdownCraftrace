...
export class StatsScene extends ReplayStatsScene{
  ...
  _installBroadcastStyles(){
    ...
    s.textContent=`
      ...
      @media(max-height:430px){.br-native-monitor{min-height:0!important;height:auto!important}.br-native-screen{height:252px}.br-native-monitor .br-monitor-head{height:44px}.br-replay-modal{padding:5px}.br-replay-modal__screen{height:300px;min-height:0;padding-bottom:102px}.br-replay-modal__head{height:40px}.br-tel-bottom{bottom:52px;height:50px}.br-replay-controls{height:52px}.br-replay-controls button{height:32px}.br-tel-card{padding:6px 8px}.br-tel-row{padding-top:2px;margin-top:2px}}
    `;
