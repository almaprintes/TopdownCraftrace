...
export class RaceScene extends CurrentRaceScene{
  ...
  _createStatsReplayOverlay(payload){
    ...
    try{
      ...
      diag.innerHTML='<div style="font-size:8px;font-weight:1000;letter-spacing:.14em;color:#63f3a5">DEV 1.0.191 · ONLINE GHOST DIAGNOSTIC</div>'+
      ...
      const diag=document.createElement('div');diag.style.cssText='position:absolute;right:12px;bottom:72px;padding:8px 10px;background:#240b0b;border:1px solid #ff6b6b;font-size:9px;z-index:2';diag.textContent='GHOST DIAGNOSTIC ERROR: '+String(err?.message||err);root.appendChild(diag);
    }
