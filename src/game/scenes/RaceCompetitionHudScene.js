...
export class RaceScene extends StyledRaceScene {
  create() {
    ...
    try {
      ...
      this._syncCompetitionHud = () => {
        ...
        // Splits exactos: evitamos estimaciones falsas durante la vuelta.
  ...
  update(time, delta) {
    ...
    try {
      ...
      // Al cerrar vuelta mostramos durante dos segundos el delta total exacto
      // contra el mejor tiempo que existía antes de cruzar meta.
