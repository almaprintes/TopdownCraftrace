...
export class SettingsScene extends CurrentSettingsScene {
  ...
  _installLanguageCardStyle(){
    ...
    style.textContent=`
      ...
      #tdr-settings2 .lang-card.en:after{opacity:.92;background:linear-gradient(90deg,transparent 0 38%,#012169 38% 62%,transparent 62% 100%),linear-gradient(34deg,transparent 0 45%,rgba(255,255,255,.96) 45% 49%,#c8102e 49% 51%,rgba(255,255,255,.96) 51% 55%,transparent 55% 100%),linear-gradient(-34deg,transparent 0 45%,rgba(255,255,255,.96) 45% 49%,#c8102e 49% 51%,rgba(255,255,255,.96) 51% 55%,transparent 55% 100%),linear-gradient(90deg,transparent 0 46%,rgba(255,255,255,.97) 46% 48%,#c8102e 48% 52%,rgba(255,255,255,.97) 52% 54%,transparent 54% 100%),linear-gradient(180deg,transparent 0 42%,rgba(255,255,255,.97) 42% 46%,#c8102e 46% 54%,rgba(255,255,255,.97) 54% 58%,transparent 58% 100%),linear-gradient(90deg,rgba(0,0,0,.2),transparent 30%,transparent 70%,rgba(0,0,0,.24))}
