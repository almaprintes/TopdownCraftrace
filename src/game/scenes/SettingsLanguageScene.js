...
export class SettingsScene extends CurrentSettingsScene {
  ...
  _installLanguageCardStyle(){
    ...
    style.textContent=`
      ...
      @media(max-width:760px){#tdr-settings2 .lang-grid{gap:5px}#tdr-settings2 .lang-card{height:50px;border-radius:11px}#tdr-settings2 .lang-card .lang-content{height:50px;padding:6px 22px 6px 42px}#tdr-settings2 .lang-card .lang-flag{left:7px;width:24px;height:24px}#tdr-settings2 .lang-card .lang-name{font-size:10px;letter-spacing:.02em}#tdr-settings2 .lang-card .lang-sub{font-size:7px}#tdr-settings2 .lang-card .lang-code{top:5px;right:6px;font-size:7px}#tdr-settings2 .lang-card .lang-check{top:4px;left:4px;width:13px;height:13px;font-size:7px}}
    `;
