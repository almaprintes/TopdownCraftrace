  ...
  _recordSurvivalAiTelemetry(){
    ...
    for(const b of this._survivalBots||[]){
      ...
      telemetry.pushSample({
        ...
        straightLock:Boolean(b._plannerControl?.straightLock),
        straightDeadband:Boolean(b._plannerControl?.straightDeadband),
        straightLocalCurvature:Number(b._plannerControl?.straightLocalCurvature||0),
        straightApproachCurvature:Number(b._plannerControl?.straightApproachCurvature||0),
