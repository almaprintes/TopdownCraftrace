...
const NEW_VEGETATION=[
  {cat:'VEGETACIÓN',id:'tree_broad_03',path:'environment/vegetation/tree_broad_03.webp',w:240},
  {cat:'VEGETACIÓN',id:'tree_broad_04',path:'environment/vegetation/tree_broad_04.webp',w:240},
  {cat:'VEGETACIÓN',id:'tree_broad_05',path:'environment/vegetation/tree_broad_05.webp',w:240},
  {cat:'VEGETACIÓN',id:'bush_round_01',path:'environment/vegetation/bush_round_01.webp',w:170},
  {cat:'VEGETACIÓN',id:'plant_broadleaf_01',path:'environment/vegetation/plant_broadleaf_01.webp',w:160},
  {cat:'VEGETACIÓN',id:'plant_rosette_01',path:'environment/vegetation/plant_rosette_01.webp',w:160},
  {cat:'VEGETACIÓN',id:'plant_sword_01',path:'environment/vegetation/plant_sword_01.webp',w:160},
  {cat:'VEGETACIÓN',id:'plant_tropical_01',path:'environment/vegetation/plant_tropical_01.webp',w:175},
  {cat:'VEGETACIÓN',id:'plant_variegated_01',path:'environment/vegetation/plant_variegated_01.webp',w:160},
  {cat:'VEGETACIÓN',id:'plant_variegated_02',path:'environment/vegetation/plant_variegated_02.webp',w:160}
];

export class EnvironmentBuilderScene extends Current{
  preload(){
    super.preload?.();
    for(const a of NEW_VEGETATION){
      const key=`env:${a.id}`;
  ...
  _catalogItemsForCategory(category){
    const inherited=super._catalogItemsForCategory?.(category)||[];
    if(category!=='VEGETACIÓN')return inherited;
    const ids=new Set(inherited.map(a=>a?.id).filter(Boolean));
    return inherited.concat(NEW_VEGETATION.filter(a=>!ids.has(a.id)));
  }
