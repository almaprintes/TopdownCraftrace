...
export class SettingsScene extends CurrentSettingsScene {
  ...
  _footer(panelX,panelY,panelW,panelH){
    ...
    this.add.text(panelX+86,fy+27,'RESTABLECER',{fontFamily:'system-ui,-apple-system,Segoe UI,Arial',fontSize:'11px',fontStyle:'bold',color:'#ffffff'}).setOrigin(.5).setDepth(1003);
    reset.on('pointerup',()=>{
      this.settings={
    ...
    this.add.text(panelX+panelW-16,fy+27,'Guardado ✓',{fontFamily:'system-ui,-apple-system,Segoe UI,Arial',fontSize:'11px',fontStyle:'bold',color:'#2bff88'}).setOrigin(1,.5).setDepth(1003);
  }
