    ...
    try {
      ...
      if (worldPts.length >= 2) {
        ...
        worldPts.forEach((p, i) => {
          const x = ox + p.x * fitScale, y = oy + p.y * fitScale;
      ...
      marker.fillStyle(0x05131c, 0.95); marker.fillCircle(0, 0, 5);
      marker.lineStyle(2, 0xffffff, 0.95); marker.strokeCircle(0, 0, 4);
      marker.fillStyle(0x63ffd1, 1); marker.fillTriangle(0, -5, -2.4, 1.8, 2.4, 1.8);
