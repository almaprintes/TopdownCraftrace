...
export function createGame(parentId='app'){
  ...
  // Controlled iOS render A/B: WebKit MSAA can be disproportionately expensive on
  // a moving full-screen WebGL scene. Keep every other setting identical and disable
  // antialias only on iOS so we can verify whether sustained frame cadence recovers.
