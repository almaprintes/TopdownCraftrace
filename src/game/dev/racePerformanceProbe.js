...
function installAndroidDomIsolation(){if(!androidDevice()||document.getElementById('tdr-android-dom-isolation'))return;const s=document.createElement('style');s.id='tdr-android-dom-isolation';s.textContent='#tdr-live-delta-panel{backdrop-filter:none!important;-webkit-backdrop-filter:none!important}';document.head.appendChild(s);}
