...
@media(max-width:700px){.tdr-season-celebration .stage{padding:12px 14px 14px}.tdr-season-celebration .title{font-size:clamp(22px,8vw,36px)}.tdr-season-celebration .art-wrap{width:min(72vw,280px);height:min(34vh,210px);flex-basis:min(34vh,210px)}.tdr-season-celebration .hero{justify-content:center}.tdr-season-celebration .qty{margin-top:10px;font-size:clamp(28px,10vw,46px)}.tdr-season-celebration .name{margin-top:3px;font-size:clamp(15px,5vw,22px)}.tdr-season-celebration .saved{margin-top:4px;font-size:9px}.tdr-season-celebration .continue{min-width:min(82vw,340px);height:44px}}
@media(max-height:520px){.tdr-season-celebration .stage{padding:10px 22px 10px}.tdr-season-celebration .title{font-size:clamp(22px,4vw,38px)}.tdr-season-celebration .art-wrap{height:min(44vh,220px);width:min(48vw,320px);flex-basis:min(44vh,220px)}.tdr-season-celebration.car .art-wrap{height:min(50vh,270px);width:min(68vw,620px);flex-basis:min(50vh,270px)}.tdr-season-celebration .qty{font-size:clamp(30px,5vw,50px)}.tdr-season-celebration .name{font-size:clamp(14px,2vw,22px)}.tdr-season-celebration .continue{height:38px}}
