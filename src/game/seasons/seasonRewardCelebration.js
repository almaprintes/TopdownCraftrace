...
.tdr-season-celebration .hero{align-self:center;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:0;max-height:100%;width:100%}.tdr-season-celebration .art-wrap{position:relative;width:min(48vw,360px);height:min(42vh,250px);display:grid;place-items:center;flex:0 0 min(42vh,250px)}.tdr-season-celebration.car .art-wrap{width:min(76vw,760px);height:min(58vh,390px);flex-basis:min(58vh,390px)}.tdr-season-celebration .art-wrap:before{content:'';position:absolute;inset:8%;border-radius:50%;background:radial-gradient(circle,rgba(98,255,178,.23),transparent 66%);filter:blur(12px)}.tdr-season-celebration.car .art-wrap:before{background:radial-gradient(circle,rgba(240,198,90,.34),transparent 68%)}.tdr-season-celebration .art{position:relative;z-index:2;max-width:100%;max-height:100%;object-fit:contain;filter:drop-shadow(0 20px 18px rgba(0,0,0,.62));animation:tdrHeroIn .7s .08s cubic-bezier(.18,.9,.28,1.28) both}.tdr-season-celebration .qty{position:relative;z-index:4;margin-top:10px;font-size:clamp(30px,5vw,58px);font-weight:1000;line-height:.9;color:#ffe06a;text-shadow:0 5px 18px #000}.tdr-season-celebration .name{position:relative;z-index:4;margin-top:6px;font-size:clamp(16px,2.4vw,28px);font-weight:1000;letter-spacing:.05em}.tdr-season-celebration .saved{position:relative;z-index:4;margin-top:6px;font-size:clamp(8px,1.1vw,11px);font-weight:800;letter-spacing:.1em;color:#9ab0bf}
...
@media(max-width:700px){.tdr-season-celebration .stage{padding:12px 14px 14px}.tdr-season-celebration .title{font-size:clamp(22px,8vw,36px)}.tdr-season-celebration .art-wrap{width:min(64vw,250px);height:min(30vh,190px);flex:0 0 min(30vh,190px)}.tdr-season-celebration .hero{justify-content:center}.tdr-season-celebration .qty{margin-top:10px;font-size:clamp(28px,10vw,46px)}.tdr-season-celebration .name{margin-top:3px;font-size:clamp(15px,5vw,22px)}.tdr-season-celebration .saved{margin-top:4px;font-size:9px}.tdr-season-celebration .continue{min-width:min(82vw,340px);height:44px}}
@media(max-height:520px){.tdr-season-celebration .stage{padding:10px 22px 10px}.tdr-season-celebration .title{font-size:clamp(22px,4vw,38px)}.tdr-season-celebration .art-wrap{height:min(34vh,190px);width:min(44vw,280px);flex:0 0 min(34vh,190px)}.tdr-season-celebration.car .art-wrap{height:min(50vh,270px);width:min(68vw,620px);flex-basis:min(50vh,270px)}.tdr-season-celebration .qty{font-size:clamp(30px,5vw,50px)}.tdr-season-celebration .name{font-size:clamp(14px,2vw,22px)}.tdr-season-celebration .continue{height:38px}}
